...
#'
#' @param taxonType Character string for the taxonTypeCode. Must be one of ALGAE, GEETLE, BIRD,
#' FISH, HERPETOLOY, MACROINVERTEBRATE, MOSQUITO, MOSQUITO_PATHOGENS, SMALL_MAMMAL, PLANT, TICK
#' @param recordReturnLimit Integer. The number of items to limit the result set to. If NA, will return all records in table.
#' @param stream Character string. Option to obtain the result as a stream. Utilize for large requests.
#'
